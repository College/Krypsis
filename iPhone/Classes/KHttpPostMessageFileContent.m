...
@implementation KHttpPostMessageFileContent
...
- (id) initWithContentType:(NSString *)_contentType name:(NSString *)_name fileName:(NSString *)_fileName data:(NSData *)_data 
{
    ...
    {
        [self setContentType:_contentType];
        [self setContentDisposition:[NSString stringWithFormat:@"form-data; name=\"%@\"; filename=\"%@\"", _name, _fileName]];
    }
    return self;
}
@end
