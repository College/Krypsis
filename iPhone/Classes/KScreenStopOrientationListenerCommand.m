...
@implementation KScreenStopOrientationListenerCommand
...
- (void) executeWithDelegate:(KrypsisAppDelegate *) appDelegate andRequest:(KRequest *) request 
{
    ...
    {
        [listener stop];
        [appDelegate removeValueFromScope:ORIENTATION_LISTENER];
    }
    
    KSuccessResponse *response = [[KSuccessResponse alloc] initWithRequest:request];
