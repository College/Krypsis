...
@implementation KLocationStartObserverLocationCommand
...
- (void) executeWithDelegate:(KrypsisAppDelegate *) appDelegate andRequest:(KRequest *) request {
    ...
    listener = [[KLocationListener alloc] initWithAppDelegate:appDelegate andRequest:request];
    [appDelegate putValueInScope:listener forKey:LOCATION_LISTENER];
