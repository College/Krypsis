...
public class StopOrientationListenerCommand implements Command {
  private final Logger logger = LoggerFactory.getLogger(StopOrientationListenerCommand.class);

  public void execute(Module module, Requestable request, ResponseDispatchable dispatchable) {
    final ModuleListener listener = (ModuleListener) module.get(Screens.ORIENTATION_LISTENER);
